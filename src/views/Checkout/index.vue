<script setup>
import { putOrder, getCheckInfo} from '@/apis/Checkout';
...
<template>
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @click="changeAddress">切换地址</el-button>
  ...
  <el-dialog title="切换收货地址" width="30%" center v-model="isShow">
    <div class="addressWrapper">
      <div class="text item " v-for="item in checkInfo.userAddresses" :class="item.id=== selectedAddress.id?'active':''"  :key="item.id"  @click="checkAddress(item)">
        <ul>
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="changeNewAddress">确定</el-button>
      </span>
    </template>
  </el-dialog>
  <!-- 添加地址 -->
